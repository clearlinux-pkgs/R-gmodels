...
Version  : 2.19.1
Release  : 58
URL      : https://cran.r-project.org/src/contrib/gmodels_2.19.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/gmodels_2.19.1.tar.gz
...
%setup -q -n gmodels
pushd ..
cp -a gmodels buildavx2
popd
pushd ..
cp -a gmodels buildavx512
popd
pushd ..
cp -a gmodels buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740093889
...
/usr/lib64/R/library/gmodels/NEWS.md
